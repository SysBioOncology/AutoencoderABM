...
#%% General parameters 
oneStepDuration = 12 #1 for Leiden # 12 hours for one step 
height = 100
width = 100
...
sim_iter = 2 # number of times to perform simulation with same parameter set (mean is used for loss function)
...
TUpprol = 0.1 #0.5055 # leiden = 0.21
TUpmig = 0.05 # default 0.35, leiden = 0.05 
...
IMpprol = 4.6289e-04
IMpdeath = 1.5173e-04
IMinfluxProb = 0.1 #0.1 for directed migration, 0.33 default 
IMinfluxRate = 1
IMrateDynamic = 0.0075
IMrwalk = 1 #0.5
engagementDuration = 48
IMinfluxEdge = True # influx only at edge if True, else random through entire grid
IMdirectedWidth = 0
